...
Note that every commit in your PR is required to be signed with an identity
trusted by your Github account. Without this, the PR will not be mergeable. For
information on how to set this up, see [this guide](./doc/git-gpg.md).
