...
namespace jest
{
  ...
  { jank::common::interpret("translate/plugin/compare/pass_integer.jank"); }

  template <> template <>
  void jank::equal_group::test<1>()
  { jank::common::interpret("translate/plugin/compare/pass_real.jank"); }

  template <> template <>
  void jank::equal_group::test<2>()
  { jank::common::interpret("translate/plugin/compare/pass_string.jank"); }
}
