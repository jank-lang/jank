...
namespace jest
{
  ...
  { jank::common::translate("translate/variable/non-generic/define/pass_deduce_type.jank"); }
  ...
  void jank::define_group::test<12>()
  {
    ...
    ([]{ jank::common::translate("translate/variable/non-generic/define/fail_multiple_values.jank"); });
  }
}
