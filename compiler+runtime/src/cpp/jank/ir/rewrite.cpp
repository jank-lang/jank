...
namespace jank::ir
{
  static bool rewrite(identifier &name, identifier const &old_name, identifier const &new_name)
  {
    if(name == old_name)
    {
      name = new_name;
                    ...
                    identifier const &new_name)
  {
    ...
    switch(inst->kind)
    {
      ...
      case instruction_kind::set_local:
        {
          auto &i{ static_cast<inst::set_local &>(*inst.data) };
          rewritten |= rewrite(i.local, old_name, new_name);
      ...
      case instruction_kind::persistent_list:
        {
          ...
          for(auto &v : i.values)
          {
            rewritten |= rewrite(v, old_name, new_name);
          }
        }
        break;
      ...
      case instruction_kind::persistent_array_map:
        {
          ...
          for(auto &v : i.values)
          {
            rewritten |= rewrite(v.first, old_name, new_name);
            rewritten |= rewrite(v.second, old_name, new_name);
          }
        }
        break;
      ...
      case instruction_kind::closure:
        {
          ...
          {
            rewritten |= rewrite(c.second.name, old_name, new_name);
          }
        }
        break;
      ...
      case instruction_kind::dynamic_call:
        {
          ...
          rewritten |= rewrite(i.fn, old_name, new_name);
          for(auto &arg : i.args)
          {
      ...
      case instruction_kind::jump:
        {
          ...
          rewritten |= rewrite(i.block, old_name, new_name);
        }
        break;
      ...
      case instruction_kind::branch:
        {
          ...
          rewritten |= rewrite(i.merge_block, old_name, new_name);
        }
        break;
      case instruction_kind::loop:
        {
          ...
          rewritten |= rewrite(i.loop_block, old_name, new_name);
          rewritten |= rewrite(i.merge_block, old_name, new_name);
        }
        break;
      ...
      case instruction_kind::try_:
        {
          ...
          {
            rewritten |= rewrite(c.second, old_name, new_name);
          }
          rewritten |= rewrite(i.finally_block, old_name, new_name);
          rewritten |= rewrite(i.merge_block, old_name, new_name);
        }
        break;
      ...
      case instruction_kind::cpp_unbox:
        {
          ...
          rewritten |= rewrite(i.value, old_name, new_name);
          rewritten |= rewrite(i.meta, old_name, new_name);
        }
        break;
