...
namespace jank::runtime::obj
{
  ...
  {
    runtime::to_string(const_cast<range *>(this)->seq(), buff);
  }

  jtl::immutable_string range::to_string() const
  {
    return runtime::to_string(const_cast<range *>(this)->seq());
  }

  jtl::immutable_string range::to_code_string() const
  {
    return runtime::to_code_string(const_cast<range *>(this)->seq());
  }
