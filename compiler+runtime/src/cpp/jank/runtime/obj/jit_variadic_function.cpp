...
{
  jit_variadic_function::jit_variadic_function()
    : object{ obj_type, obj_behaviors }
  {
  }

  jit_variadic_function::jit_variadic_function(callable_arity_flags const arity_flags)
    : object{ obj_type, obj_behaviors }
    , arity_flags{ arity_flags }
  {
  }

  jit_variadic_function::jit_variadic_function(object_ref const meta)
    : object{ obj_type, obj_behaviors }
    , meta{ meta }
  {
  }

  void jit_variadic_function::to_string(jtl::string_builder &buff) const
  {
  ...
  jit_variadic_function_ref jit_variadic_function::with_meta(object_ref const m)
  {
    auto const new_meta(behavior::detail::validate_meta(m));
    auto const ret{ make_box<jit_variadic_function>(*this) };
    ret->meta = new_meta;
    return ret;
  }

  object_ref jit_variadic_function::get_meta() const
  {
    return meta.get();
  }

  void jit_variadic_function::set_meta(object_ref const o)
  {
  ...
  object_ref do_call(F const fn, jit_variadic_function const * const obj, Args... args)
  {
    if(!fn)
    {
  ...
  object_ref jit_variadic_function::call() const
  {
    switch(arity_flags)
    {
  ...
  object_ref jit_variadic_function::call(object_ref const a1) const
  {
  ...
  object_ref jit_variadic_function::call(object_ref const a1, object_ref const a2) const
  {
    auto const mask(extract_variadic_arity_mask(arity_flags));
  ...
  object_ref
  jit_variadic_function::call(object_ref const a1, object_ref const a2, object_ref const a3) const
  {
    auto const mask(extract_variadic_arity_mask(arity_flags));
  ...
  object_ref jit_variadic_function::call(object_ref const a1,
                                         object_ref const a2,
                                         object_ref const a3,
