...
(def namespaces
  '[
    ...
    ; clojure.core-test.ancestors ; Unable to resolve symbol 'Object'.
    ...
    clojure.core-test.counted-qmark
    ...
    clojure.core-test.list-qmark ; INFO: SKIP - defprotocol
    ...
    clojure.core-test.reversible-qmark
    ...
    clojure.core-test.sorted-qmark
    clojure.core-test.special-symbol-qmark
