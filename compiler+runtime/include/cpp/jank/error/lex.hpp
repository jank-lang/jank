...
namespace jank::error
{
  ...
  error_ptr
  lex_invalid_unicode(jtl::immutable_string const &message, read::source const &source);
  error_ptr
  ...
  error_ptr
  lex_invalid_keyword(jtl::immutable_string const &message, read::source const &source);
