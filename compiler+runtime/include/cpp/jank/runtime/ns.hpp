...
namespace jank::runtime
{
  ...
  struct ns : gc
  {
    ...
    jtl::result<void, native_persistent_string> unmap(obj::symbol_ptr const &sym);

    jtl::result<void, native_persistent_string> add_alias(obj::symbol_ptr const &sym, ns_ptr const &ns);
    void remove_alias(obj::symbol_ptr const &sym);
    jtl::option<ns_ptr> find_alias(obj::symbol_ptr const &sym) const;

    jtl::result<void, native_persistent_string> refer(obj::symbol_ptr const sym, var_ptr const var);
