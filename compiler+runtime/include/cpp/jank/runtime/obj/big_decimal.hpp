...
namespace jank::runtime::obj
{
  ...
  //f64 operator+(T const l, native_big_decimal const &r)
  //{
  //  return l + r.convert_to<f64>();
  //}

  //template <typename T>
  //requires std::is_floating_point_v<T>
  //f64 operator+(native_big_decimal const &l, T const r)
  //{
  //  return l.convert_to<f64>() + r;
  //}

  //template <typename T>
  //requires std::is_integral_v<T>
  //big_decimal_ref operator+(T const l, native_big_decimal const &r)
  //{
  //  return make_box<big_decimal>(r + l);
  //}

  //template <typename T>
  //requires std::is_integral_v<T>
  //big_decimal_ref operator+(native_big_decimal const &l, T const r)
  //{
  //  return make_box<big_decimal>(l + r);
  //}
