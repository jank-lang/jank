...
namespace jank::runtime::detail
{
  ...
  KV *make_next_array(KV const * const prev, size_t const length, KV const key, KV const value)
  {
    switch(length)
    {
      ...
      case 4:
        {
          auto const ret(new(GC) KV[6]{ prev[0], prev[1], prev[2], prev[3], key, value });
          return ret;
        }
      case 6:
        {
          auto const ret(
            new(GC) KV[8]{ prev[0], prev[1], prev[2], prev[3], prev[4], prev[5], key, value });
          return ret;
        }
      case 8:
        {
          auto const ret(new(GC) KV[10]{ prev[0],
                                         prev[1],
                                         prev[2],
                                         prev[3],
                                         prev[4],
      ...
      case 10:
        {
          auto const ret(new(GC) KV[12]{ prev[0],
                                         prev[1],
                                         prev[2],
                                         prev[3],
                                         prev[4],
      ...
      case 12:
        {
          auto const ret(new(GC) KV[14]{ prev[0],
                                         prev[1],
                                         prev[2],
                                         prev[3],
                                         prev[4],
      ...
      case 14:
        {
          auto const ret(new(GC) KV[16]{ prev[0],
                                         prev[1],
                                         prev[2],
                                         prev[3],
                                         prev[4],
