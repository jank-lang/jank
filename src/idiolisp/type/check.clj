(ns idiolisp.type.check
  (:require [idiolisp.parse.fabricate :as fabricate]
            [idiolisp.type.scope.type-declaration :as type-declaration]
            [idiolisp.type.scope.type-definition :as type-definition]
            [idiolisp.type.scope.binding-declaration :as binding-declaration]
            [idiolisp.type.scope.binding-definition :as binding-definition]
            [idiolisp.type.scope.macro-definition :as macro-definition]
            [idiolisp.type.scope.util :as scope.util]
            [idiolisp.type.expression :as expression]
            [idiolisp.type.generic :as generic]
            [idiolisp.type.return :as return]
            [idiolisp.interpret.scope.prelude :as interpret.scope.prelude]
            [idiolisp.interpret.macro :as macro]
            [idiolisp.interpret.escape :as escape])
  (:use idiolisp.assert
        idiolisp.debug.log))
